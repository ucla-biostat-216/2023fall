...
- Step 2 of iteration $i$ requires $2n(i-1)$ flops to compute $\tilde{\mathbf{q}}_i$.  

- Step 3 of iteration $i$ requires $3n$ flops to compute $\|\tilde{\mathbf{q}}_i\|$ and $\mathbf{q}_i$. 
