...
5. Let $\mathbf{A} \in \mathbb{R}^{n \times p}$. Describe how to find a sequence of Householder matrices $\mathbf{H}_1, \ldots, \mathbf{H}_{p-1}$ such that
$$
\mathbf{H}_{p-1} \mathbf{H}_{p-2} \cdots \mathbf{H}_1 \mathbf{A} = \mathbf{R},
$$
